...
public class WangPoTest implements InvocationHandler {

    private PanTest kindWomen;

    public  WangPoTest(){
        kindWomen = new PanTest();
    }

    public  WangPoTest(PanTest kindWomen){
